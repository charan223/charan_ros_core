...
if __name__ == "__main__":
    ...
    sub_filtered_seglist = rospy.Subscriber("/default/lane_filter_node/seglist_filtered", SegmentList, filtered_seglist_cb)
    pub_car_cmd = rospy.Publisher("/default/joy_mapper_node/car_cmd", Twist2DStamped, queue_size=10)
    rospy.spin()
